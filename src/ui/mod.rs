...
use crate::action::{Interface, Selection};
// #[cfg(not(test))]
...
// TODO@Module: extract into it's own file?
pub mod colors {
    const WHITE: u8 = 15;
    const BLACK: u8 = 16;

    pub const AT_LEAST_ONE: usize = 1;
    pub const REQUIRED_COLOR: usize = 2;
    pub const OPTIONAL_COLOR: usize = 3;
    pub const UNSETTABLE_COLOR: usize = 4;
}
